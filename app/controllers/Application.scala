/**
  ...
  * always in the focus. Thus we have not always used the most concise / terse
  * code that we could have.
  *
  * The ScalaBlog also became the training ground for our efforts to
  * better understand "BIG DATA". Subsequently is uses Hadoop and some related
...
object Application extends Controller {
    ...
    // User Administration manin page
    def userconfig = Action {
        Ok(views.html.userconfig())
    }

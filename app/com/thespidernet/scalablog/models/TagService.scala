/**
  ...
  *     written against.
  *
  * Your application code (E.g. Tag class) shouldn't know or care about
  * caching, it just needs to ask for data / save data changes etc.
  *
  * And the actual task of retrieving the data from and writing the data to
  * persistent storage (hard disk) is the domain of the "Gateway" objects or
  * Data Access Objects (DAOs)
  *
  * From a process flow perspective the Service classes sit between these two
  * end-points.
  * This makes them the perfect the place to include (for example) code that
  * relates to Caching.
  *

/**
  ...
  * It contains all "native" code for getting data into and out of physical
  * storage.
  *
  * E.g. Actual SQL, ORM instructions.
  * All in native dialects for the databases supported.
  *
  * If you support three different database platforms - you may well have 3
  * versions of each action, here.
  *
  * ***************************************************************************
  */

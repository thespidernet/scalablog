/**
  ...
  * Hadoop
  *
  * This is the PostService Object (Singleton)
  *
  * It is the "Factory" for the Posts class and;
  *
  ...
  *     written against.
  *
  * Your application code (E.g. Post class) shouldn't know or care about caching. it just needs

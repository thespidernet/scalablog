/**
  ...
  * Hadoop
  *
  * This is the CommentService Object (Singleton)
  *
  * It is the "Factory" for the Comment class and;
  *
  ...
  *     written against.
  *
  * Your application code (E.g. Comment class) shouldn't know or care about caching. it just needs

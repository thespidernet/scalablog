...
class UtilitiesUnitSuite extends UnitSpec with Matchers {

  //Define All the UNIT tests you want to run for the Utilities class.

  //Instantiate the Utilities Class
  test("Utilities Unit : Instantiate the com.thespidernet.Utilities Class, directly") {
    val theUtilties = new Utilities() shouldBe a[Utilities] //shouldBe tests for type equality
  }
}

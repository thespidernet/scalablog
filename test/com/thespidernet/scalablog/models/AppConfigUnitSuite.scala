/**
  ...
  *
  * This is the AppConfig Unit Testing Object
...
/**
  ...
  */
class AppConfigUnitSuite extends UnitSpec with Matchers {

  //Define All the UNIT tests you want to run for the AppConfig class.

  //Instantiate the models.AppConfig Class
  test("AppConfig Unit : Instantiate the ...models.AppConfig Class, directly") {
    val theAppCOnfig = new AppConfigData(
      blogTitle = "TestBlogTitle",
      blogTagLine = "TestBlogTagLine",
      blogTitleImage = "TestBlogImage",
      blogUrl = "TestBlogURL",
      modifiedBy = NormalUserData("GavinB", "Gavin", "Baumanis"),
      accurateAt = new java.util.Date()) shouldBe a[AppConfigData] //shouldBe tests for type equality
  }

  //Create a new AppConfig via the AppConfig Companion Object
  test("AppConfig Unit : Instantiate the ...models.AppConfig Class, via the Companion Object") {
  ...
  //Test XXXXXXXX
  test("AppConfig Unit : True Is True") {
    assert(true == true)
  }
}
